  ...
  namespace http {
     ...
     class connection 
     {
       public:
         ...
         http::reply  request( const std::string& method, const std::string& url, const std::string& body = std::string(), const headers& = headers(), const std::string& content_type = "application/json");
